...
export default function QuranBck({ slug }: Prop) {
    ...
    useEffect(() => {
        ...
        if (activeTab == 'chapters' || activeTab == 'verses') {
            selected = (chapter as Chapter)?.name_simple?.toLowerCase() == slug;
        }

        // if (activeTab == 'juzs' || activeTab == 'pages') {
        //     if (!slug) return;
        ...
        //     selected =
        //         activeTab == 'juzs'
        //             ? (chapter as Juz).juz_number == parseInt(id)
        //             : (chapter as Page).page_number == parseInt(id);
        // }
    ...
    const handleGetScript = async (page: string) => {
        try {
            ...
            // if (activeTab == 'juzs') {
            //     payload.juz = (chapter as Juz).juz_number.toString();
            // }

            // if (activeTab == 'pages') {
            //     payload.juz = (chapter as Page).page_number.toString();
            // }
    ...
    const getArabicDigit = (num: number) => {
        let arabic_str = num
            .toString()
            .split('')
    ...
    return (
        <>
            ...
            {!audioFiles.length || !chapter ? (
                <div className="mx-5 my-5 flex h-screen max-w-3xl items-center justify-center rounded-md bg-brand-accent md:mx-auto md:w-full">
                    <div className="w-1/2">
                        <img
                ...
                <div className="mx-5 md:mx-auto">
                    {script && chapter && (
                        <div className="flex w-full flex-col">
                            {(activeTab == 'chapters' ||
                                activeTab == 'verses') && (
                                <div className="mx-auto flex h-fit w-full max-w-3xl flex-col gap-y-2 rounded-b-md bg-brand-accent p-3 shadow-md">
                                    <div className="flex items-center gap-x-5">
                                        <h1 className="surah-name text-7xl text-white">
                                            {chapter.id
                                                .toString()
                                                .padStart(3, '00')}
                                        </h1>
